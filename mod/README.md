...
| `mod/tools/check-palette-pool.py` | One plot of 70 distinct blocks exports; a second plot of 70 more exhausts the pool even though both ask for their own part palette, because the character comes from one global ledger whatever the palette placement says |
