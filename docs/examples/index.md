...
It's also how this wiki keeps itself honest: if `validate.py` and the mod ever disagree, one of them is wrong and it's worth finding out which. The bundle above passes with zero errors and zero warnings.

!!! note "It doesn't check everything"
