...
- The building keeps one part reference with **no conditions**, which is what prevents the [most common failure](../reference/building.md#floor-coverage-the-most-common-failure).
